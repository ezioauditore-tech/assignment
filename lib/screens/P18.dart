            ...
            children: [
              ...
              Container(
                  ...
                  child:  Padding(padding: const EdgeInsets.only(left: 30, top: 20),
                    child: Text("DIGITAL MEMBER CARD",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w300,fontSize: 15),),
                  )
              ),
              Container(
                height: 550,
                width: 400,
                color: Color.fromRGBO(0, 0, 35, 1),
                child: Padding(padding: const EdgeInsets.only(left: 75,top: 120,bottom: 190,right: 75),
                  child: Container(
                    height: 200,
                    width: 200,
                    color: Colors.white54,
                    child: Padding(padding: const EdgeInsets.only(left: 0,top: 0),
